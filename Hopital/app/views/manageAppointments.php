...
<body class="">
    <nav class="navbar navbar-light bg-light fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="manageAppointmentsPatient.php?results=addAppointments">Ajout d'un rendez-vous</a>
            <a class="navbar-brand" href="infoAppointments.php?results=infoAppointments">Informations des rendez-vous</a>
            <p></p>
        </div>
    </nav>
    <h1 class="text-center mt-5 ">Listes des rendez-vous</h1>
